...
FileMonitor::FileMonitor(const std::string monitoredFolder, const int serverPort, const std::string hostAddress) : Thread(std::bind(&FileMonitor::execute, this, std::placeholders::_1), NULL)
{
